...
export const getDisplayName = (svcInfo, lang?: Lang) => {
  lang = lang || guessLang();
  let res = getServiceName(svcInfo.svcAttrCd, lang);
...
export const isApp = (userAgent?: string) => {
  ...
  return userAgent.indexOf('TWM_APP') === -1 ? false : true;
};
...
export const loginUrl = (baseUrl: string, lang: Lang) =>
  `${typeof baseUrl === 'string' ? baseUrl : ''}/${
    lang === 'EN' ? 'en/' : ''
  }common/tid/login?target=${getPathname()}&app=${isApp() ? 'Y' : 'N'}`;
/*
