...
const skipTwmComparison = ['/v6/my', '/v6/mau'];
      ...
      <ModalProvider>
        ...
        */}
        ...
        {typeof window !== 'undefined' && PAGES_WITHOUT_BOTTOM_NAVI.includes(window.location.pathname) && (
          <BottomNav show={false} showBottomSheet="N" />
        )}
      </ModalProvider>
    </AppProvider>
  );
...
App.getInitialProps = async (context) => {
  ...
  // FIXME: Start of MAU 달성 Project (주석 제거 필요)
  /* 
  ...
  */
  // FIXME: End of MAU 달성 Project (주석 제거 필요)
  ...
  // FIXME: Start of MAU 달성 Project
  // let twmCopy: string = isSSR ? context.ctx.req.cookies.TWMCopy : getCookie('TWMCopy');
  // FIXME: End of MAU 달성 Project
  ...
  const pageProps = { twm, sessionUpdatedAt, myInfo, userType, LDSP, isInitialIssue, isLogin, path };
  return { pageProps };
};
