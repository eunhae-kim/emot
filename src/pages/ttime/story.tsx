...
export default function TtimeStory({ storyProps }) {
  ...
  const resetWhenPopstate = () => {
    console.log('no resetWhenPopstate');
  ...
  return (
    <>
      ...
      >
        ...
        <div className={`tTime-container ${isShowLoginToast ? 'tTime-container-detail' : ''}`}>
          ...
          {storyInfo && (
            <>
              ...
              <XtrAw appEid="CMMA_A23_B121_C1419_D4439-2" webEid="CMMA_A23_B121_C1419_D4439-2" xtrClick xtrView>
        ...
        {/* 티타임 이야기 로그인 토스트 */}
        {isShowLoginToast && (
          <XtrAw appEid="CMMA_A23_B121_C1419_D4439-3" webEid="CMMA_A23_B121_C1419_D4439-3" xtrClick xtrView>
            <TtimeToast
