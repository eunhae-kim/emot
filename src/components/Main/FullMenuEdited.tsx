...
export function FullMenuEdited() {
  const { confirm, fullMenuEdit } = useModal();
  ...
  return (
    <div className="fullmenu popup-fullmenu overlay-modal">
      ...
      >
        ...
        <NavFullMenu checkedMenu={checkedMenu} setCheckedMenu={setCheckedMenu} menu={menuList} edited />
