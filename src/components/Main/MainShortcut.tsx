...
export function MainShortcut({ shortCutMenuList, toggleState, isOverFlow, toggleTab }: shortCutList) {
    ...
    <>
      ...
      <ul id="menuItems" className={`list-grid-menu-items ${toggleState ? 'active' : ''}`}>
        {shortCutMenuList.length > 0 ? (
          ...
          <li>
            <button type="button" className="btn-rounded-dotted" onClick={fullMenuEdit.show}>
