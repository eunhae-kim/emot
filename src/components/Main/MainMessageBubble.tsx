...
function component({ message, scrollToCard, svcMgmtNum }: MainItemBoxProps) {
    ...
    <>
      {displayMsg && displayYn && (
        <MessageBubble
          ...
          oferStcCd={displayMsg.oferStcCd}
          onClickMessage={
            displayMsg.linkUrl
              ? () => {
  ...
  //   <>
  //     {displayMsg && displayYn && (
  //       <article className="card-main-notification">
  //         {displayMsg.linkUrl ? (
...
export const MainMessageBubble = React.memo(component);
