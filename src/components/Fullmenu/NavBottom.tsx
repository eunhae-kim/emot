      ...
      <div className="g-bottom-nav">
        <ul className={classnames(['g-nav-list', { en: lang === 'EN' }])} role="tablist">
          ...
          <li className="nav-home" role="presentation">
            {' '}
            <Xtr xtrEid={guessLang() === 'KO' ? 'MWMA_A20-237' : 'MWMA_A10_B79-100'} xtrClick={true}>
          ...
          {lang === 'KO' && (
            <li className="nav-shop" role="presentation">
              {' '}
              <Xtr xtrEid={guessLang() === 'KO' ? 'MWMA_A20-238' : ''} xtrClick={true}>
                {/* 2023-01-12 접근성 / aria 추가 */}
          ...
          <li className="myt">
            <Xtr xtrEid={guessLang() === 'KO' ? 'MWMA_A20-239' : 'MWMA_A10_B79-101'} xtrClick={true}>
          ...
          {lang === 'KO' && (
            <li className="nav-bf" role="presentation">
              {' '}
              <Xtr xtrEid={guessLang() === 'KO' ? 'MWMA_A20-240' : ''} xtrClick={true}>
                {/* 2023-01-12 접근성 / aria 추가 */}
          ...
          <li className="nav-nemu" role="presentation">
            {' '}
            <Xtr xtrEid={guessLang() === 'KO' ? 'MWMA_A20-241' : 'MWMA_A10_B79-102'} xtrClick={true}>
              {/* 2023-01-12 접근성 / aria 추가 */}
