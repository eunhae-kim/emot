    ...
    <div className="troom-typeinfo-content">
      ...
      <div className="story-info">
        <ul className="info-list">
          <li>
            <XtrAw appEid="CMMA_A23_B121_C1419_D4440-1" webEid="CMMA_A23_B121_C1419_D4440-1" xtrClick xtrView>
          ...
          <li>
            <XtrAw appEid="CMMA_A23_B121_C1419_D4440-2" webEid="CMMA_A23_B121_C1419_D4440-2" xtrClick xtrView>
