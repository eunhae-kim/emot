    ...
    <main className="container myweb" id="contents">
      ...
      <div aria-hidden={!isOpen} className={`overlay ${isOpen ? 'active' : ''}`} role="dialog" aria-modal="true">
        <div className="layer-type-detail">
          ...
          <MyMembership
            text={setMyMembership.args.text}
            rank={setMyMembership.args.rank}
            btnType={setMyMembership.args.btnType}
            disabled={setMyMembership.args.disabled}
            btnName={setMyMembership.args.btnName}
            descText={setMyMembership.args.descText}
            descSubText={setMyMembership.args.descSubText}
          />
