  ...
  switch (ex.type) {
    ...
    case '서비스점검중':
      result = {
        loading: false,
        exIcon: 'ic-inspect',
        exTit: 'Service Temporarily Unavailable',
        exSubTit: `Please try again later<br/>${formatYYYYMDHHmm(ex.apiResp.block.fromDtm)}~${formatYYYYMDHHmm(
                  ...
                  {lastMonthBillsDisplayData?.이용요금 && (
                    <>
                      <XtrAw appEid="CMMA_A10_B134-9" webEid="MWMA_A10_B134-23" xtrClick xtrView>
                        <MyVolume over1={무선요금} overUnit0="￦" link="/en/myt-fare/submain" />
                      </XtrAw>
